...
def check_grad_gamma_images():    
    ...
    for gamma_filename in all_gamma_filenames:
        ...
        # Predict the gamma
        pred_gamma = Assign01.estimate_gamma_exponent(image, ground_output)
        pred_transform = Assign01.get_gamma_transform(pred_gamma)
        pred_output = Assign01.apply_intensity_transform(image, pred_transform)
